...
namespace Service.Application.Mappers
{
    public static class EntityMappingExtensions
    {
        ...
        public static CenterProductGetDto ToGetDto(this CenterProduct centerProduct) => new()
        {
            ...
            TopOfRedExecution = centerProduct.TopOfRedExecution,
            TopOfYellowExecution = centerProduct.TopOfYellowExecution,
            TopOfGreenExecution = centerProduct.TopOfGreenExecution,
            RedSafeAnalytical = centerProduct.RedSafeAnalytical,
